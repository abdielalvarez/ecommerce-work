                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav mr-auto">
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle text-white" onClick={this.toggleOpenTypes} href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                TIPOS
                            </a>
                            <div className={menuClassTypes} aria-labelledby="navbarDropdown">
                        ...
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle text-white" onClick={this.toggleOpenCharacters} href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                PERSONAJES
                            </a>
                            <div className={menuClassCharacters} aria-labelledby="navbarDropdown">
                        ...
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle text-white" onClick={this.toggleOpenDays} href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                DÍAS FESTIVOS
                            </a>
                            <div className={menuClassDays} aria-labelledby="navbarDropdown">
                    ...
                    <form className="form-inline my-2 my-lg-0">
                        <input 
                            className="form-control mr-sm-2 rounded-pill search"
                            type="search"
                            placeholder="Search"
                            aria-label="Search"
                        />
                        <button className="btn btn-outline border-white text-white my-2 my-sm-0" type="submit">Search</button>
                    </form>
                </div>
            </nav>
        )
